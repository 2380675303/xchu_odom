...
#include "xchu_mapping/points_filter_node.h"
...
int main(int argc, char **argv) {
  ...
  // 订阅odom节点见图
  ros::Subscriber lidar_sub = nh.subscribe<sensor_msgs::PointCloud2>("/kitti/velo/pointcloud", 10, PointCb);
  ...
  std::thread laser_processing_process{Process};
